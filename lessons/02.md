...
TODO short video discussing ids and timestamps, SQL from AR methods, SQL GUI setup
...
### Task 3: Add a new mentor and offload some assignments for an overloaded mentor
- A new volunteer, Frank Smith, has signed up to be a mentor. His email is frank.smith@test.com.
  - We'll create a mentor record for Frank with the data we have.
